...
print("Testing MoG-RPCA (Bayesian RPCA)...")
print(f"Input shape: {M.shape}")

result = run_algorithm('RPCA', 'MoG-RPCA', M, params={'r': 1, 'mog_k': 3, 'maxiter': 10})
...
print(f"Final rank: {result.get('rank', 'N/A')}")
