"""RSTD: Robust Sparse Tensor Decomposition.

Ports algorithms/td/RSTD/run_alg.m.
Reference: Li and Schonfeld, 2015.
"""
...
@register("TD", "RSTD", "RSTD (Li and Schonfeld, 2015)", speed_class=3, is_tensor=True)
class RSTD(Decomposer):
    """Robust Sparse Tensor Decomposition."""
