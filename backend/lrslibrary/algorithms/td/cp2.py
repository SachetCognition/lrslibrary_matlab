"""CP2: CP decomposition variant 2.

Ports algorithms/td/CP2/run_alg.m.
...
@register("TD", "CP2", "CP2 (Kolda and Bader, 2009)", speed_class=2, is_tensor=True)
class CP2(Decomposer):
    """CP decomposition variant 2."""
