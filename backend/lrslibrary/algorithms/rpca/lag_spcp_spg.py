...
Ports algorithms/rpca/Lag-SPCP-SPG/run_alg.m.
...
@register("RPCA", "Lag-SPCP-SPG", "Lagrangian SPCP-SPG (Aravkin et al. 2014)", speed_class=3)
class LagSPCPSPG(Decomposer):
    """Lagrangian SPCP solved by Spectral Projected Gradient."""
