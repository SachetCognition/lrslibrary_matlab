"""Bayesian RPCA-MD with Non-Stationary Noise (BRPCA-MD-NSS).

Ports algorithms/rpca/BRPCA-MD-NSS/run_alg.m.
...
@register("RPCA", "BRPCA-MD-NSS", "Bayesian RPCA-MD-NSS (Ding et al. 2011)", speed_class=4)
class BRPCAMDNSS(Decomposer):
    """Bayesian Robust PCA with Markov Dependency and Non-Stationary Noise."""
