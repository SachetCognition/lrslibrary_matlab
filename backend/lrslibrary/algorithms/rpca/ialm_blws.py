"""IALM + BLWS algorithm for Robust PCA.

Ports algorithms/rpca/IALM_BLWS/run_alg.m.
Reference: Lin and Wei, 2010.
"""
...
@register("RPCA", "IALM_BLWS", "IALM + BLWS (Lin and Wei, 2010)", speed_class=2)
class IALMBLWS(Decomposer):
    """Inexact ALM with BLWS line search for Robust PCA."""
