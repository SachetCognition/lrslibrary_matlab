"""Flip-Flop SPCP-sum solved by Spectral Projected Gradient.

Ports algorithms/rpca/flip-SPCP-sum-SPG/run_alg.m.
...
@register("RPCA", "flip-SPCP-sum-SPG", "SPCP-sum-SPG (Aravkin et al. 2014)", speed_class=3)
class FlipSPCPSumSPG(Decomposer):
