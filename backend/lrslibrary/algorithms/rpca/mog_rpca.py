"""MoG-RPCA: Mixture of Gaussians RPCA.

Ports algorithms/rpca/MoG-RPCA/run_alg.m.
...
@register("RPCA", "MoG-RPCA", "MoG-RPCA (Zhao et al. 2014)", speed_class=3)
class MoGRPCA(Decomposer):
