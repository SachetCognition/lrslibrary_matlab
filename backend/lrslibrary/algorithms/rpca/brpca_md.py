"""Bayesian RPCA with Markov Dependency (BRPCA-MD).

Ports algorithms/rpca/BRPCA-MD/run_alg.m.
Reference: Ding et al. 2011.
"""
...
@register("RPCA", "BRPCA-MD", "Bayesian RPCA-MD (Ding et al. 2011)", speed_class=4)
class BRPCAMD(Decomposer):
    """Bayesian Robust PCA with Markov Dependency.

    Simplified port using IALM-based approach since the full Bayesian
    MCMC implementation requires specialized sampling.
    """
    ...
    def decompose(
        ...
        # Use IALM-based approach as proxy for Bayesian method
        Y = M.copy()
