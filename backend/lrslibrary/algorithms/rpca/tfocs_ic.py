...
Ports algorithms/rpca/TFOCS-IC/run_alg.m.
...
@register("RPCA", "TFOCS-IC", "TFOCS-IC (Becker et al. 2011)", speed_class=3)
class TFOCSIC(Decomposer):
    """TFOCS with inequality constraints for RPCA."""
